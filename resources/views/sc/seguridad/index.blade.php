...
@section('title', 'Seguridad de farmacia')

@section('content_header')
<h4 class="m-0">Seguridad de farmacia</h4>
@stop
...
@section('js')
    ...
    <script src="{{ asset('js/sc/seguridad.js?2') }}"></script>
@stop