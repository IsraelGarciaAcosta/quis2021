...
<h4 class="m-0">Editar resguardo</h4>
@stop
    ...
    <div class="card-body">
        <div class="overlay-wrapper col-md-12">
            <div class="overlay" id="overlay" style="position:fixed; display:none">
                ...
                @include('sc/resguardo.resume')

			    @include('sc/resguardo.form')

                <div align="right">
                    <a href="/resguardo" class="btn btn-danger">Cancelar</a>
...
@section('js')
    ...
    <script src="{{ asset('js/sc/resguardo.js?2') }}"></script>
@stop