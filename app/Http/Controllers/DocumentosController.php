...
class DocumentosController extends Controller
{
    ...
    public function list_formatos(Request $request)
  {
    ...
    ->addColumn('download_delete', function ($formatos) {
      $html5 = '<button type="button" class="btn btn-info btn-sm" title="Descargar" href="javascript:void(0)" onclick="download_formatos('.$formatos->id.')"><span class="far fa-file-pdf"></span></button>
