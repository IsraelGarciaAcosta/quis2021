...
class ContenidosController extends Controller
{
    ...
    {
        $contenidos = Contenidos::where('empresa_id', '=', session('id_empresa'))->get();
    ...
    public function cargar_modulos(Request $request)
    {
        ...
        ->where('empresa_id', $empresa_id)->orderBy('no15')->get()->toJson();
    ...
    public function cargar_temas(Request $request)
    {
        ...
        ->where('empresa_id', $empresa_id)->orderBy('no18')->get()->toJson();
    ...
    public function list_modulo(Request $request)
    {
        ...
        ->where('empresa_id', $empresa_id)->orderBy('no15')->get();
    ...
    public function list_actividad(Request $request)
    {
        ...
        ->where('empresa_id', $empresa_id)->orderBy('no21')->get();
    ...
    public function list_recurso(Request $request)
    {
        ...
        ->where('empresa_id', $empresa_id)->orderBy('no26')->get();
